...
### Les nouvelles données réalisées dans l'article nous permettent de comparer l'article initiale utilisant des OTU aux nouvelles données créées en ASV. Ceci nous permet de rendre compte des deux méthodes et de voir s'il existe une différence entre elles. 
