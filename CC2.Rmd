...
dim(seqtabAll)
```
## Le résultat affiche <table of extent 0> malgré de nombreux essais pour changer cela, je n'ai pas trouvé le problème pour résoudre cette erreur. N'ayant pas de résultats pour cette commande, je ne peux pas exécuter les suivantes contenant "seqtabNoC" et bloquant ainsi toutes les autre commandes.  
